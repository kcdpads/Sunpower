                ...
                <li>
                    ...
                    <div class="collapse in" id="componentsExamples">
                        <ul class="nav">
                            ...
                            <li prop="menu" id="fourFree"><a href="#" onclick="javascript:left.pageSubmitFn('fourFree')">4주 프리</a></li>
                            <li prop="menu" id="fourCh"><a href="#" onclick="javascript:left.pageSubmitFn('fourCh')">4주 취업</a></li>
                            <li prop="menu" id="fourCh2"><a href="#" onclick="javascript:left.pageSubmitFn('fourCh2')">4주 취업2</a></li>
                        </ul>
                    </div>
                </li>
